...
const getProjectDetails = tool(
  async ({ question }) => {
    ...
    return `Project: Local Complete Playground
Tech Stack: TypeScript, LangGraph, LangChain, OpenAI, TrikHub
Status: Active development
Features: Storage capabilities, Configuration management, Tool calling, LangSmith tracing`;
  },
  {
 ...
 * - Config loading
 * - Session management
 * - Storage and config context injection
 */
